---
name: llm-token-cost-reduction
description: "Review ranked LLM token sinks and apply consent-gated cost-lowering fixes; use when asked to lower an agent's token cost or trim heavy context."
license: MIT
tags:
- llm
- cost
