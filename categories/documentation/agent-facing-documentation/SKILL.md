---
name: agent-facing-documentation
description: "Write or edit agent-consumed documents like skills and AGENTS.md using context pointers, progressive disclosure, and leading words for predictable behavior."
license: MIT
tags:
- agent-docs
- documentation
