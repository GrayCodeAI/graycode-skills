...
description: "Create and maintain concise AGENTS.md project instruction files, referencing external docs and commands while keeping them under 60 lines and avoiding duplication."
license: Apache-2.0
tags:
- documentation
- agents
