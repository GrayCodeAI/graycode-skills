...
description: "Create or rewrite a README for the project consumer with verified install commands and runnable quickstart; use when asked to write a README."
license: MIT
tags:
- documentation
- readme
