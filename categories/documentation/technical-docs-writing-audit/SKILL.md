---
name: technical-docs-writing-audit
description: "Write and audit technical documentation with type gating, runnable examples, and documentation rules; use to review or write API reference docs."
license: MIT
tags:
- documentation
- docs
