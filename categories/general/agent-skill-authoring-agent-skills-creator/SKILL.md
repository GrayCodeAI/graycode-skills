---
name: agent-skill-authoring-agent-skills-creator
description: "Create and improve portable agent skills with validation, routing scenarios, and keep/cut/merge decisions; use when asked to write or audit a skill."
license: MIT
tags:
- skills
- agent
...
- **IS NOT:** AGENTS.md instruction files (use `agents-md`) or general documentation quality (use `docs-writing`).
...
- `agents-md` for auditing AGENTS.md instruction files
