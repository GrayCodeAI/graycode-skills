---
name: coding-session-retrospective
description: "Run a retrospective on a coding session and propose improvements to the agent environment: navigation, automated checks, standards, and tool economy."
license: MIT
tags:
- retrospective
- agent-environment
...
- `AGENTS.md`: this file are pushed to the context window of any agent working in this repo. They should be used incredibly sparingly, usually only for **navigation pointers** to other files.
