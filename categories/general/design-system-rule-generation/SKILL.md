---
name: design-system-rule-generation
description: "Generate project-specific design system rules that encode component, styling, token, and architecture conventions for consistent design-to-code implementation."
license: MIT
tags:
- design-system
- design
...
|-------|-----------|-------|
| Claude Code | `AGENTS.md` in project root | Markdown format. Can also use `.claude/rules/figma-design-system.md` for modular organization. |
