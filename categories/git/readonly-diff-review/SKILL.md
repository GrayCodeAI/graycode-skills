---
name: readonly-diff-review
description: "Review a diff or security scope read-only using evidence-tiered findings; use when asked to review changes or do a security audit."
license: MIT
tags:
- code-review
- pr
