...
description: "Lay out the folder structure for a new Expo app with Expo Router, deciding where routes, components, screens, server code, and utilities should live."
license: MIT
tags:
- project-structure
- scaffolding
