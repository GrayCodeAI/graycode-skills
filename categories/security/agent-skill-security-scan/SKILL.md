...
description: "Scan agent skills for security issues before adoption, detecting prompt injection, malicious scripts, excessive permissions, secret exposure, and supply-chain risks."
license: Apache-2.0
tags:
- security
- skills
