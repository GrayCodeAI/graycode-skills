...
description: "Audit GitHub Actions workflows for exploitation vulnerabilities like pwn requests, expression injection, credential theft, and supply-chain attacks, reporting only confirmed findings with PoCs."
license: Apache-2.0
tags:
- security
- github-actions
